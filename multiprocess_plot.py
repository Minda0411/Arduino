...
# Reads data from a thread, plots it in another Process, 
# with main process being free all the time ! 
# Using PyQtGraph, python standard multiprocessing and multiprocessing.Queue
# -*- coding: utf-8 -*-
